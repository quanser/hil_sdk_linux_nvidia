Quanser HIL SDK 2020 (4.0.2949)
-----------------------------------

The Quanser HIL SDK for the Ubuntu operating system running on Nvidia Jetson™ or Nano™ board. The Quanser Hardware-in-the-loop (HIL) SDK, also known as the Quanser HIL SDK, provides device drivers and a set of C functions (API) for accessing Quanser hardware (devices and data acquisition cards).  

The Quanser HIL SDK for the Ubuntu operating system running on Nvidia Jetson™ or Nano™ provides access to the following devices:
- Quanser QUBE Servo 2 - USB 
- Quanser Aero USB 
- Quanser Q2-USB (normal mode only)

To install the Quanser HIL SDK on Ubuntu for Nvidia Jetson or Nano:
...
The Quanser HIL SDK documentation and examples on Ubuntu for Nvidia Jetson or Nano:
...
To uninstall the Quanser HIL SDK on Ubuntu for Nvidia Jetson or Nano:
...
The full version of this product is 4.0.2949. The build date was 2020/1/22.
